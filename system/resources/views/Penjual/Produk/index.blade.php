							...
							<tr>
								...
								<td>
									<div class="btn btn-group">
										...
										<a href="{{ url('penjual/produk', $produk->id) }}" class="btn btn-primary"><i class="fa fa-info"></i></a>

										<a href="{{ url('penjual/produk', $produk->id) }}/edit" class="btn btn-warning"><i class="fa fa-edit"></i></a>
